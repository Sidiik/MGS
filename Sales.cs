...
namespace point_of_sale_mgs
{
    public partial class Sales : UserControl
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cr.Show();
            cn.Open();
            SqlCommand cmd = new SqlCommand("SELECT OrderNo,OrderDATE,CUSTOMERName,Item,price,Quantity,total,CustomerPhone from orders where OrderDATE='" + dateTimePicker1.Value + "' and CustomerID='" + txtidd.Text+"'", cn);
